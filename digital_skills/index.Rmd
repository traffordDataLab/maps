...
df <- read_csv("data/digital_skills_services.csv") %>%
  mutate(Category = fct_relevel(as_factor(Category),
                             level = c("Community hub", "Library", "Charity/community group", "Education establishment", "Retailer", "Job Centre")),
         `Target audience` = fct_relevel(as_factor(`Target audience`),
                             level = c("Everyone", "Adults and young people with disabilities", "Customers", "Families", "Individuals with hearing impairment", "Older people", "Students", "Unemployed", "Women", "Young people")),
