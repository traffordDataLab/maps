...
df <- read_csv("data/digital_skills_services.csv") %>%
  mutate(Category = fct_relevel(as_factor(Category),
                             level = c("Community hub", "Library", "Charity/community group", "Education establishment", "Training provider", "Retailer", "Job Centre")),
         `Target audience` = fct_relevel(as_factor(`Target audience`),
                             level = c("Everyone", "Adults and young people with disabilities", "Customers", "Families", "Individuals with hearing impairment", "Jobseekers", "Older people", "Residents", "Students", "Women", "Young people")),
