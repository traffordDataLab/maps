...
df <- read_csv("data/digital_skills_services.csv") %>%
  mutate(Category = fct_relevel(as_factor(Category),
         ...
         `Target audience` = fct_relevel(as_factor(`Target audience`),
                             level = c("Everyone", "Adults and young people with disabilities", "Customers", "Elderley", "Families", "Individuals with hearing impairment", "Students", "Unemployed", "Women", "Young people")),
