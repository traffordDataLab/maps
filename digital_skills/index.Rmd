...
div(class = "container-fluid",
    ...
    div(class = "row",
        ...
        div(class = "col-xs-6 col-sm-3 col-md-3 col-lg-3", 
            ...
            filter_checkbox(id = "Device lending scheme", label = "Device lending scheme", sharedData = sd, group = ~ifelse(`Device lending scheme` == "x", "Available", NA), inline = TRUE),
            br(),
        ...
        div(class = "col-xs-6 col-sm-3 col-md-3 col-lg-3", 
            list(
              ...
              br(),
              # Access
            filter_checkbox(id = "Access", label = "Access", sharedData = sd, group = ~ifelse(Access == "x", "Available", NA), inline = TRUE)
              ))),
    br(),
